...
# Palavras para ignorar na assinatura
            ...
            with st.status("Verificando datas e CLP...", expanded=True) as status:
                ...
                if d_l[0]:
                    ...
                    for linha in linhas:
                        ...
                        # Filtro de Assinatura: Se a linha contém termos de assinatura, ignora
                        if any(term in l_upper for term in FILTRO_ASSINATURA):
                            continue
                            
                        # Se estiver em uma seção e a linha parecer nome de navio (Mínimo 3 letras, sem ser link)
